...
namespace Be.Auto.Hangfire.Dashboard.RecurringJobManager.Core.Extensions
{
    public static class GlobalConfigurationExtensions
    {
        ...
        private static void AddEmbeddedResources()
        {
            ...
            AddDashboardRouteToEmbeddedResource("/job-manager/js/daysjs", "application/javascript", "Be.Auto.Hangfire.Dashboard.RecurringJobManager.Dashboard.Content.js.daysjs.min.js");
            AddDashboardRouteToEmbeddedResource("/job-manager/js/relativeTime", "application/javascript", "Be.Auto.Hangfire.Dashboard.RecurringJobManager.Dashboard.Content.js.relativeTime.min.js");
